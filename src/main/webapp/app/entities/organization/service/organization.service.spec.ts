...
import { OrganizationService, RestOrganization } from './organization.service';

const requireRestSample: RestOrganization = {
  ...sampleWithRequiredData,
  dateOfRegestation: sampleWithRequiredData.dateOfRegestation?.toJSON(),
  dateOfDeRegestation: sampleWithRequiredData.dateOfDeRegestation?.toJSON(),
};
