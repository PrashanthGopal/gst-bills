package com.religate.gstbills.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.religate.gstbills.service.EmailAlreadyUsedException ||
            ex instanceof com.religate.gstbills.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.religate.gstbills.service.InvalidPasswordException
